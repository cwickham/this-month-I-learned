...
style_duo_accent(
  ...
  extra_css = list(
    ".inverse code" = list("color" = "#ffffff"),
    ".title-slide a" = list("color" = "#ffffff"))
)
```
...
[`r icons::icon_style(icons::fontawesome("github"), fill = "#1381B0")` @cwickham](https://github.com/cwickham)  
[`r icons::icon_style(icons::fontawesome("twitter"), fill = "#1381B0")` @cvwickham](https://twitter.com/cvwickham)
]

.right-column[
## Hello, my name is Charlotte Wickham
...
.pull-left[
When you update, read over the release news:
...
For me, sporadic, intensive, "R time" usually built around conferences
